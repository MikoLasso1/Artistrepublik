  ...
  <v-card flat class="text-center w-100">
    ...
    <v-form class="mt-4" v-model="valid" ref="form">
      <v-row align="center">
        <v-col cols="12">
          <v-card-text>
            <p class="my-0">List your review services and make money!</p>
            <p class="my-0">Receive submissions from our network of 20,000+ artists.</p>
            <p class="my-0">Discover new music and new content to keep your page poppin.</p>
...
export default {
  data: function () {
    return {
      ...
      error: null,
      agreeStatus: false,
      termConditionsUrl: 'https://arepublik-static.s3.amazonaws.com/documents/Elite+Reviews+T%26C.pdf'
    }
  },
  watch: {
    agreeStatus: {
